...
import styles from './SocialWorksAdminPage.module.scss';
...
export const SocialWorksAdminPage = (props: Props) => {
  ...
  const { socialWorks, isLoading, getSocialWorks } = useAdminSocialWorks(
    !!isArchived
  );
