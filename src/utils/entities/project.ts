...
export const mapProjectToAPI = (
  ...
  return {
    primary_info: {
      ...
      main_results: project.basicQualityResults || null,
      ...
      photo_file_path: project.photo || '123' /* TODO: create photo flow */,
      ...
      is_has_innovative_platform: project.hasExpertMention,
    },

    info: {
      implementation_period: project.period || null,
      technologies_forms_methods: project.technologies || null,
      main_results: project.basicAmountResults || null,
