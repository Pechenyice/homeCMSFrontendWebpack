...
import {
  ...
  IEducationProgramWithMetadataResponse,
} from './../responses';
import { safeFetch } from './../wrapper';
import { IAPIEducationProgram } from 'types/entities/educationProgram';

const ENTITY = EEntity.EDUCATION_PROGRAM;
...
export const EDUCATION_PROGRAM_CONTROLLER = {
  get(
    id: string,
    userId: number | undefined,
    isAdmin: boolean | undefined
  ): Promise<IEducationProgramWithMetadataResponse> {
  ...
  create(
    data: Partial<IAPIEducationProgram>,
    userId: number
