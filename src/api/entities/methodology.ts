...
import {
  ...
  IMethodologyWithMetadataResponse,
} from './../responses';
import { safeFetch } from './../wrapper';
import { IAPIClub } from 'types/entities/club';
import { IAPIMethodology } from 'types/entities/methodology';

const ENTITY = EEntity.METHODOLOGY;
...
export const METHODOLOGY_CONTROLLER = {
  get(
    id: string,
    userId: number | undefined,
    isAdmin: boolean | undefined
  ): Promise<IMethodologyWithMetadataResponse> {
