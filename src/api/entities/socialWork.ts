...
import {
  ...
  ISocialWorkWithMetadataResponse,
} from './../responses';
import { safeFetch } from './../wrapper';
import { IAPISocialWork } from 'types/entities/socialWork';

const ENTITY = EEntity.SOCIAL_WORK;
...
export const SOCIAL_WORK_CONTROLLER = {
  get(
    id: string,
    userId: number | undefined,
    isAdmin: boolean | undefined
  ): Promise<ISocialWorkWithMetadataResponse> {
